...
export async function GET(
  ...
  try {
    ...
    // Verify volunteer has signed up for this event
...
export async function POST(
  ...
  try {
    ...
    // Create message (volunteers can only send regular messages, not announcements)
    ...
    // Get volunteer info for the response
    ...
    const enrichedMessage = {
      ...
      user: volunteerInfo
        ? {
            id: volunteerInfo.id,
            name: volunteerInfo.name || `${volunteerInfo.firstName} ${volunteerInfo.lastName}`,
